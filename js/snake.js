    ...
    */
    ...
    return function(inputConfig) {
        ...
        var me = this,
            ...
            // Board components
            elmContainer, elmPlayingField, elmAboutPanel, elmLengthPanel, elmHighscorePanel, elmTryAgain, elmWin, elmPauseScreen;
        ...
        function createBoardElements() {
            ...
            p1Snake = new SNAKE.Snake({playingBoard:me,startRow:5,startCol:5,premoveOnPause: config.premoveOnPause});
            p2Snake = new SNAKE.Snake({playingBoard:me,startRow:10,startCol:10,premoveOnPause: config.premoveOnPause});
 
            p1Snake.snakeHead.elm.className += " player1-snake";
            p2Snake.snakeHead.elm.className += " player2-snake";
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "JavaScript Snake 1vs1<p></p>green: W-A-S-D <p></p> yellow: ← ↑ → ↓" + fullScreenText + "<p></p>";
        ...
        function handleEndCondition(elmDialog) {
            var index = Math.max(getNextHighestZIndex(p1Snake.snakeBody), getNextHighestZIndex({ tmp: { elm: myFood.getFoodElement() } }));
        ...
        me.setupPlayingField = function () {
            ...
            myKeyListener = function(evt) {
                ...
                if (me.getBoardState() === 1) {
                    if (
                        // Player 1 con teclas de flecha
                        (keyNum >= 37 && keyNum <= 40) ||
                        // Player 2 con teclas WASD
                        ...
                        myKeyListener = function(evt) {
                            ...
                            // Verifica si la tecla presionada corresponde a Player 1 o Player 2
                            if (keyNum >= 37 && keyNum <= 40) {
                                p1Snake.handleArrowKeys(keyNum); // Player 1 con teclas de flecha
                            } else if (keyNum === 87 || keyNum === 65 || keyNum === 83 || keyNum === 68) {
                                p2Snake.handleArrowKeys(keyNum); // Player 2 con teclas WASD
                            }
        ...
        */
        me.foodEaten = function() {
            elmLengthPanel.innerHTML = "Length: " + p1Snake.snakeLength;
            if (p1Snake.snakeLength > localStorage.jsSnakeHighScore)
            {
                localStorage.setItem("jsSnakeHighScore", p1Snake.snakeLength);
